/**
 *  Hack for Ecolink Z-Wave Wireless Tilt Sensor - ECO-TILT-US to make it look more like the traditional SmartThings 
 *	Sensor for garage doors. This is a combination of the the Z-Wave code and Smarthings.
 * 
 *  Author: 	Johnny Physix
 *  Date: 		2016-04-18
 *
...
metadata {
	definition (name: "JP Z-Wave Garage Tilt Sensor", namespace: "jphilbert", author: "Johnny Physix") {
	...
	tiles {
        ...
        */
		...
		main(["status","contact"])
		details(["status","contact", "battery"])
	}
}
