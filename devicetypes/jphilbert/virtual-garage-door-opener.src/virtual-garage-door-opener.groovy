 ...
 */
metadata {
	definition (name: "Virtual Garage Door Opener", namespace: "jphilbert", author: "John P. Hilbert") {
		capability "Actuator"
...
def open() {
    ...
    runIn(1, finishOpening) 	// changed from 6s
}

def close() {
    sendEvent(name: "door", value: "closing")
	runIn(1, finishClosing)		// changed from 6s
}
