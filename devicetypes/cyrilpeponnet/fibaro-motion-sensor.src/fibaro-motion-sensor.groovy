...
metadata {
    ...
    preferences {
        input description: "Once you change values on this page, the `Synced` Status will become `pending` status. You can then force the sync by triple click the b-button on the device or wait for the next WakeUp (every 2 hours).",
